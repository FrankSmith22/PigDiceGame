...
<html>
	<head>
		...
		<link rel="stylesheet" href="stylesFlex.css?v=<?php echo date( "U" );?>">
	...
	<body>
		<div id="appHolder">
			<div id="introductionContainer">
				<div id="welcome">
					<p id="welcomeHeader">Welcome to PIG! A game about rolling dice</p><br>
				</div>
				<div id="landscapeColumns">
					<div id="rules">
					...
					<div id="nameFields">
						<p>Player one: <input id="playerOneNameInput" size="12" type="text"></p>
						<p>Player two: <input id="playerTwoNameInput" size="12" type="text"></p>
					</div>
				</div>
			</div>
