...
c.initialize = function(){
	...
	c.startGame();
	v.playerOneNameInput.addEventListener('keydown', c.setPlayers);
	v.playerTwoNameInput.addEventListener('keydown', c.setPlayers);
...
c.hideIntroduction = function(){
	v.introduction.style.visibility = "hidden";
	v.introduction.style.opacity = "0";
};

c.showIntroduction = function(){
	v.introduction.style.visibility = "visible";
	v.introduction.style.opacity = "1";
};
